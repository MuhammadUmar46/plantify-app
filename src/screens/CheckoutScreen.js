import {
  ...
  import COLORS from '../componants/color';
        ...
        <SafeAreaView
          ...
          <View style={{marginTop: 10}}>
            <View style={{flexDirection: 'row', marginTop: 5}}>
              ...
              <View style={{flexDirection: 'row', marginLeft: 25, marginTop: 25}}>
                <Text style={{fontSize: 14, color:"#001240" ,width: 165, fontWeight: '700'}}>
                ...
                />
                <Text style={{color:"#001240" ,fontSize: 14, fontWeight: '500', marginLeft: 20}}>
                  $350
                </Text>
              </View>
            </View>
            <View
              ...
              <Button color="#001240"  title="-" onPress={() => RemoveQuantity()} />
              <TouchableOpacity>
              <Image
          ...
          <View style={{marginTop: 10}}>
            <View style={{flexDirection: 'row', marginTop: 5}}>
              ...
              />
              <View style={{flexDirection: 'row', marginLeft: 25, marginTop: 25}}>
                <Text style={{color:"#001240", fontSize: 14, width: 165, fontWeight: '700'}}>
          ...
          <View>
            <View
              ...
              <Text style={{marginLeft: 8, color:"#001240",fontSize: 15, fontWeight: '700'}}>
                Delivery
              </Text>
            ...
            <View style={{marginLeft: 80, marginTop: -10}}>
              <Text style={{color:"#001240", width: 150, fontSize: 13, fontWeight: '500'}}>
          ...
          <View style={{marginTop: 10}}>
            <View style={{flexDirection: 'row', marginTop: 5}}>
              ...
              />
              <View style={{flexDirection: 'row', marginLeft: 25, marginTop: 25}}>
                <Text style={{color:"#001240",fontSize: 15, width: 165, fontWeight: '700'}}>
