import { View, Text, Image, ScrollView, SafeAreaView, TouchableOpacity, TouchableHighlight } from 'react-native';
    ...
    <ScrollView>
      <SafeAreaView
        ...
        <View>
          ...
          />
          <Text style={{ top: 300, left: 25, fontWeight: '700', fontSize: 14 }}>Plant Bio</Text>
          <Text style={{ top: 310, left: 25, width: 320, fontSize: 15, fontWeight: "400" }}>
            No green thumb required to keep our artificial watermelon peperomia
            plant looking lively and lush anywhere you place it.
          </Text>
          <View style={{ left: 25, display: 'flex', flexDirection: 'row', marginTop: 330 }}>
            <Image
        ...
        <View>
          <Text style={{ fontSize: 14, fontWeight: "700", marginLeft: 25, marginTop: 20, color: "#002140" }}>Similar Plants</Text>
        </View>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", backgroundColor: "#F5EDA8", width: 415, height: 176, marginTop: 30, marginBottom: 10 }}>
          <View>
            <Text style={{ fontSize: 18, color: "#002140", width: 180, marginLeft: 36, marginTop: 30, fontWeight: "700" }}>
              That very plant?
              {'\n'}
          ...
          <Text style={{  marginTop:6 ,marginLeft:25, color: '#0D986A', fontWeight: '600', fontSize: 16}}>
            Scan Now
          </Text>
        </TouchableOpacity>
        </View>
          ...
          <View>
            <Image style={{ marginTop: 20, width: 170, height: 140, marginRight: 10 }}
